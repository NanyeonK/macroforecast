...
class Experiment:
    ...
    def __init__(
        ...
        *,
        ...
        self.custom_source_policy = custom_source_policy
        self.custom_source_format = custom_source_format
        self.custom_source_schema = custom_source_schema
        self.custom_source_path = None if custom_source_path is None else str(custom_source_path)
    ...
    def to_recipe_dict(self) -> dict[str, Any]:
        ...
        recipe = build_default_recipe_dict(
            ...
            custom_source_policy=self.custom_source_policy,
