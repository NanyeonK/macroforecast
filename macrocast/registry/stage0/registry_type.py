...
REGISTRY_TYPE_ENTRIES: tuple[EnumRegistryEntry, ...] = (
    ...
    EnumRegistryEntry(id="callable_registry", description="Callable-signature validated registry.", status="planned", priority="A"),
    EnumRegistryEntry(id="custom_plugin", description="Plugin-backed registry.", status="planned", priority="A"),
