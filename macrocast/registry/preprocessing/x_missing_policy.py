...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id='drop_rows', description='drop rows', status='operational', priority="A"),
        EnumRegistryEntry(id='drop_columns', description='drop columns', status='operational', priority="A"),
        EnumRegistryEntry(id='drop_if_above_threshold', description='drop if above threshold', status='operational', priority="A"),
        EnumRegistryEntry(id='missing_indicator', description='missing indicator', status='operational', priority="A"),
