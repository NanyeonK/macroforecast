...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id='demean_only', description='demean only', status='planned', priority="A"),
        EnumRegistryEntry(id='unit_variance_only', description='unit variance only', status='planned', priority="A"),
