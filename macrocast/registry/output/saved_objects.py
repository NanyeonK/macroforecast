...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id='models_only', description='model artifacts only', status='planned', priority='B'),
        EnumRegistryEntry(id='data_only', description='processed data artifacts only', status='planned', priority='B'),
    ),
    compatible_with={},
    incompatible_with={},
)
