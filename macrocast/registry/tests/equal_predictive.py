...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id="paired_t_on_loss_diff", description="Paired t-test on loss differential", status="operational", priority="B"),
        EnumRegistryEntry(id="wilcoxon_signed_rank",  description="Wilcoxon signed-rank on loss differential", status="operational", priority="B"),
    ),
    compatible_with={},
    incompatible_with={},
)
