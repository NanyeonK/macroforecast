...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id="fluctuation_test",   description="Giacomini-Rossi fluctuation test", status="operational", priority="B"),
        EnumRegistryEntry(id="chow_break_forecast", description="Chow-style structural break test on forecast errors", status="operational", priority="B"),
