...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id='target_specific', description='target specific', status='planned', priority='A'),
        EnumRegistryEntry(id='horizon_specific', description='horizon specific', status='planned', priority='A'),
