...
AXIS_DEFINITION = AxisDefinition(
    ...
    entries=(
        ...
        EnumRegistryEntry(id='preprocessing_effect', description='preprocessing effect', status='planned', priority='A'),
        EnumRegistryEntry(id='feature_builder_effect', description='feature builder effect', status='planned', priority='A'),
        EnumRegistryEntry(id='benchmark_effect', description='benchmark effect', status='planned', priority='A'),
