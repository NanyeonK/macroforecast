...
AXIS_VALUE_ALIASES: dict[tuple[str, str], str] = {
    ...
    ("data_richness_mode", "factor_plus_lags"): "factors_plus_target_lags",
    ...
    ("agg_target", "scale_adjusted_weight"): "scale_adjusted_weighting",
    ("agg_target", "economic_priority_weight"): "economic_priority_weighting",
    ...
    ("density_metrics", "CRPS"): "crps",
    ("density_metrics", "NLL"): "nll",
    ("density_metrics", "PIT_based_metric"): "pit_based_metric",
    ("direction_metrics", "F1"): "f1",
    ("direction_metrics", "AUC"): "auc",
    ("direction_metrics", "Brier_score"): "brier_score",
    ("point_metrics", "MSE"): "mse",
    ("point_metrics", "MSFE"): "msfe",
    ("point_metrics", "RMSE"): "rmse",
    ("point_metrics", "MAE"): "mae",
    ("point_metrics", "MAPE"): "mape",
    ("point_metrics", "sMAPE"): "smape",
    ("point_metrics", "MASE"): "mase",
    ("point_metrics", "RMSSE"): "rmsse",
    ("point_metrics", "MedAE"): "median_absolute_error",
    ("point_metrics", "Huber_loss"): "huber_loss",
    ("point_metrics", "QLIKE"): "qlike",
    ("point_metrics", "TheilU"): "theil_u",
    ("ranking", "benchmark_beat_freq"): "benchmark_beat_frequency",
    ("ranking", "MCS_inclusion_priority"): "mcs_inclusion_priority",
    ("regime_definition", "NBER_recession"): "nber_recession",
    ("regime_definition", "Markov_switching_regime"): "markov_switching_regime",
    ("regime_use", "eval_only"): "evaluation_only",
    ("relative_metrics", "relative_MSFE"): "relative_msfe",
    ("relative_metrics", "relative_RMSE"): "relative_rmse",
    ("relative_metrics", "relative_MAE"): "relative_mae",
    ("relative_metrics", "oos_R2"): "oos_r2",
    ("relative_metrics", "CSFE_difference"): "csfe_difference",
