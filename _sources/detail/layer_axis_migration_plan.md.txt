...
| `preprocess_order=tcode_only` | 2_preprocessing | compatibility bridge | Official-only order is represented by Layer 1 `official_transform_policy=apply_official_tcode`; extra orders remain Layer 2. |
