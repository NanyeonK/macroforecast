...
Polynomial-kernel ablations. Selecting ``svr_poly`` on ``l4.model`` activates this branch of the layer's runtime.

## In recipe context

Set ``params.model = "svr_poly"`` in the relevant layer to activate this op within a recipe:
