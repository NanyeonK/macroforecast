...
| `n_workers` | `int | Literal['auto']` | — | required when compute_policy=parallel; positive int or 'auto' | Process or thread pool size. ``auto`` lets the runtime choose a system-appropriate cap. |
