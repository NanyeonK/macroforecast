...
| `SearchSpec`, `SearchResult`, `SearchError`, `search_spec`, `select_params` | `macroforecast.model_selection` | Model-parameter selection over a supplied window and metric. |
| `fixed`, `grid`, `random_search`, `cv_path`, `bayesian_search`, `genetic_search`, `custom_search` | `macroforecast.model_selection` | Search specification builders. |
