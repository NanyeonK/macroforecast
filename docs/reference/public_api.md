...
| `ReportTable`, `ReportBundle`, `report_table`, `metric_report_table`, `evaluation_report_tables`, `test_report_table`, `test_provenance_table`, `latex_table`, `html_table`, `markdown_table`, `figure_data`, `report_bundle`, `render_tables` | `macroforecast.reporting` | Paper/report table formatting, forecast-metric/test presentation tables, LaTeX/HTML/Markdown rendering, and figure-ready data. |
