...
| `load_custom_csv`, `load_custom_parquet`, `list_vintages`, `fred_md_vintages`, `fred_qd_vintages`, `custom_vintages`, `combine` | `macroforecast.data` | Custom loading, vintage discovery, per-origin vintage sources, and panel combination. |
