...
| L4 | Model pipeline nodes; 42 documented model families; `ar_p` is the default family constant. |
...
| L7 | Interpretation pipeline with output controls and model-family gates. |
