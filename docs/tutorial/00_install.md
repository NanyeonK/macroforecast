...
print(f"macroforecast version: {macroforecast.__version__}")     # 0.9.0
```
...
```bash
pip install "macroforecast[all] @ git+https://github.com/NanyeonK/macroforecast.git@v0.9.2b1"
```
...
```bash
pip install "macroforecast[deep] @ git+https://github.com/NanyeonK/macroforecast.git@v0.9.2b1"
```
