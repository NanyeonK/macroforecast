...
```bash
pip install "macroforecast[all] @ git+https://github.com/NanyeonK/macroforecast.git@v0.9.0"
```
...
```bash
pip install "macroforecast[deep] @ git+https://github.com/NanyeonK/macroforecast.git@v0.9.0"
```
