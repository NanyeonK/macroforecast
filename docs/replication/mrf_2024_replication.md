...
per-cell difference over the five horizons. Model order matches the paper. LASSO-MAF /
Ridge-MAF below are the *unstandardized* runs (their standardized values — the correct
practice, see §7 item 5 — are much closer: e.g. Ridge IR 1.10→0.20, SPREAD 0.98→0.34).
`nan` marks a numerical edge in the driver (not a package fault).

**GDP** (overall mean|Δ| 0.065)

| model | h1 | h2 | h4 | h6 | h8 | mean|Δ| |
|---|---|---|---|---|---|---|
| FA-AR | 0.993/1.02 | 0.933/0.96 | 1.024/1.03 | 1.048/1.36 | 1.013/1.37 | 0.146 |
| LASSO-MAF | 0.913/0.96 | 0.923/0.98 | 1.056/0.98 | 0.926/0.98 | 0.963/1.00 | 0.054 |
| Ridge-MAF | 0.957/0.89 | 1.035/0.98 | 1.216/0.99 | 1.095/0.98 | 1.441/0.99 | 0.183 |
...
**INF** (overall mean|Δ| 0.109; standardized penalized → 0.083)

| model | h1 | h2 | h4 | h6 | h8 | mean|Δ| |
|---|---|---|---|---|---|---|
| FA-AR | 1.029/1.01 | 1.015/1.01 | 1.039/1.08 | 1.092/1.32 | 1.081/1.21 | 0.084 |
| LASSO-MAF | 0.976/0.93 | 1.107/0.96 | 1.053/0.92 | 0.984/0.96 | 0.875/0.98 | 0.091 |
| Ridge-MAF | 1.348/0.95 | 1.541/0.92 | 1.314/0.87 | 1.431/0.90 | 1.547/1.27 | 0.454 |
...
| Tiny ARRF | 0.847/0.87 | 0.938/0.87 | 0.881/0.95 | nan/0.92 | 0.862/0.94 | nan |
...
**IR** (overall mean|Δ| 0.283; standardized penalized → 0.135)

| model | h1 | h2 | h4 | h6 | h8 | mean|Δ| |
|---|---|---|---|---|---|---|
| FA-AR | 1.304/1.85 | 0.983/1.49 | 1.084/0.96 | 0.974/1.87 | 1.045/1.58 | 0.522 |
| LASSO-MAF | 2.504/1.02 | 1.955/0.96 | 2.560/1.00 | 2.425/0.95 | 2.053/0.98 | 1.317 |
| Ridge-MAF | 1.931/1.55 | 2.038/1.01 | 2.356/1.03 | 2.253/0.99 | 2.505/1.02 | 1.097 |
...
**SPREAD** (overall mean|Δ| 0.271; standardized penalized → 0.210)

| model | h1 | h2 | h4 | h6 | h8 | mean|Δ| |
|---|---|---|---|---|---|---|
| FA-AR | 0.941/1.28 | 0.916/1.13 | 0.911/0.86 | 0.906/1.51 | 0.855/1.28 | 0.327 |
| LASSO-MAF | 2.221/2.16 | 2.030/1.20 | 1.492/0.95 | 2.313/0.80 | 2.737/0.76 | 0.985 |
| Ridge-MAF | 2.247/0.93 | 1.771/0.77 | 1.410/1.01 | 1.933/1.13 | 2.319/0.96 | 0.976 |
...
**HOUST** (overall mean|Δ| 0.095)

| model | h1 | h2 | h4 | h6 | h8 | mean|Δ| |
|---|---|---|---|---|---|---|
| FA-AR | 1.031/1.13 | 1.052/1.13 | 1.003/1.11 | 1.023/1.40 | 1.009/1.04 | 0.138 |
| LASSO-MAF | 0.935/1.04 | 0.999/0.99 | 1.112/0.98 | 0.984/0.96 | 1.251/0.95 | 0.114 |
| Ridge-MAF | 1.100/0.94 | 1.260/0.94 | 1.150/0.97 | 1.102/0.96 | 1.828/0.95 | 0.336 |
...
| Tiny ARRF | 1.009/0.95 | nan/1.02 | 1.032/1.02 | 0.998/1.00 | 0.968/1.01 | nan |
...
near-exact for IR (0.009). The visible large cells are the unstandardized LASSO/Ridge
(fixed by standardization, §7 item 5), plain-RF via scikit-learn (≠ the paper's
MRF-with-`X_t=ι`), the direct vs iterated SETAR/STAR, and TV-AR (paper tunes it).
