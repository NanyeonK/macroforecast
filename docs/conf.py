...
# -- Encyclopedia ------------------------------------------------------------
# v0.7.0 replaces the previous ``docs/reference/`` auto-emit with a
# source-committed ``docs/reference/encyclopedia/`` markdown tree (moved
# from ``docs/encyclopedia/`` in C52 Diátaxis migration).
# The encyclopedia is regenerated by:
#   python -m macroforecast.scaffold encyclopedia docs/reference/encyclopedia/
