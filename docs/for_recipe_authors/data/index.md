...
[Layer Contract Design](../design.md) (and [`architecture/`](../../architecture/index.md)) defines the current L0-L8 map. L1 fixes
...
- [FRED-MD](datasets_fred_md.md) — monthly U.S. macro panel.
- [FRED-QD](datasets_fred_qd.md) — quarterly U.S. macro panel.
- [FRED-SD](datasets_fred_sd.md) — state-level mixed-frequency panel.

For column dictionaries see the
[FRED datasets section](../../for_researchers/fred_datasets/index.md) under
`for_researchers/`.

For the consolidated Layer-1 data policies axis-by-axis, see
[`../data_policies.md`](../data_policies.md).
