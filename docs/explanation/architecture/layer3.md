...
**v0.9.3 (2026-05-21)**: five selection ops promoted from `future` to `operational` (total L3 ops: 41). See `CHANGELOG.md` and `ARCHITECTURE.md` for paper references and implementation details.
...
For the full per-axis × per-option catalogue (every value with its OptionDoc summary, when-to-use / when-NOT, references), see [`l3/`](../../reference/generated/l3/index.md).
