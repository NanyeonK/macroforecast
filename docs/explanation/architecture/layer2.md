...
[L2 encyclopedia page](../../reference/l2/index.md) and per-axis
pages such as
[`mixed_frequency_representation`](../../reference/l2/axes/mixed_frequency_representation.md)
and
[`sd_tcode_policy`](../../reference/l2/axes/sd_tcode_policy.md).
...
For the full per-axis × per-option catalogue (every value with its OptionDoc summary, when-to-use / when-NOT, references), see [`l2/`](../../reference/l2/index.md).
