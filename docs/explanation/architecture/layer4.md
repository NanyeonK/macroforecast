...
L4 consumes `X_final` and `y_final`, fits forecasting models, emits forecasts, and records model/training artifacts. It is a graph layer. As of v0.9.3, L4 has **47 operational models** (`realized_garch` promoted in v0.9.3; 4 MIDAS models also promoted in v0.9.3). `FUTURE_MODEL_FAMILIES` is now empty.
