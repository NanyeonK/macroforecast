...
| Planned simple API | You want to preview the upcoming high-level Python facade (`mf.forecast` / `mf.Experiment`). For the current release use `macroforecast.run` or Detail Docs. | [Simple Docs (planned)](../simple/index.md) |
