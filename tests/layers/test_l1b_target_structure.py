...
from macroforecast.data.schema import resolve_axes_from_raw, validate_layer
...
def test_multi_series_target_rejected_as_unknown():
    ...
    from macroforecast.data.schema import validate_layer, parse_layer_yaml
    yaml_text = """
    1_data:
      fixed_axes:
...
def test_multi_series_target_not_in_target_structure_literal():
    ...
    from macroforecast.data.schema import TargetStructure
    import typing
...
def test_canonical_target_structure_is_identity():
    ...
    from macroforecast.data.schema import _canonical_target_structure
