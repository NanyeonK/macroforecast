...
def test_alfred_validator_accepts_with_snapshot_dir():
    ...
    """
    from macroforecast.data.schema import parse_layer_yaml, validate_layer
...
def test_alfred_option_status_is_operational():
    ...
    """
    from macroforecast.data.schema import L1_LAYER_SPEC
...
def test_load_alfred_vintage_snapshot_synthetic(tmp_path):
    ...
    """
    from macroforecast.data.alfred_adapter import load_alfred_vintage_snapshot
