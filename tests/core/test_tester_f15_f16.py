...
class TestF15SparseRiskPreemia:
    ...
    def test_t15_01_importable(self):
        ...
        from macroforecast.models.paper_methods import sparse_macro_factors_risk_premia  # noqa: F401
    ...
    def test_t15_02_finite_gamma_hat_on_synthetic(self):
        ...
        from macroforecast.models.paper_methods import sparse_macro_factors_risk_premia
