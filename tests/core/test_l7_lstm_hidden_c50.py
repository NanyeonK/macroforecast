...
def test_lstm_hidden_state_not_in_future_ops():
    ...
    from macroforecast.interpretation.ops import FUTURE_OPS
...
def test_lstm_hidden_state_in_default_figure_mapping():
    ...
    from macroforecast.interpretation.ops import DEFAULT_FIGURE_MAPPING
...
def test_l7_lstm_hidden_state_now_accepted():
    ...
    from macroforecast.interpretation.schema import parse_layer_yaml, validate_layer, make_l7_yaml
