...
def execute_layer(layer: dict[str, Any] | str):
    ...
    Forwards to :func:`macroforecast.core.runtime.materialize_l7_runtime` which
...
def _validate_nodes(raw: dict[str, Any], context: dict[str, Any]) -> list[Any]:
    ...
    from macroforecast.layers.l7_interpretation.ops import FUTURE_OPS, PRE_DEFINED_BLOCKS
