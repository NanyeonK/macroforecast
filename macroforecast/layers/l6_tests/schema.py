...
# NOTE: L6StatisticalTests must be defined BEFORE the deferred core imports below
...
class L6StatisticalTests:
    ...
    sub_layers = {
        "L6_A_equal_predictive": _SubLayerSpecLocal(("equal_predictive_test", "loss_function", "model_pair_strategy", "hln_correction")),
        "L6_B_nested": _SubLayerSpecLocal(("nested_test", "nested_pair_strategy", "cw_adjustment", "enc_test_one_sided")),
        "L6_C_cpa": _SubLayerSpecLocal(("cpa_test", "cpa_window_type", "cpa_conditioning_info", "cpa_critical_value_method")),
        "L6_D_multiple_model": _SubLayerSpecLocal(
            (
                "multiple_model_test",
                "mcs_alpha",
                "mmt_loss_function",
        ...
        "L6_E_density_interval": _SubLayerSpecLocal(("density_test", "interval_test", "coverage_levels", "pit_n_bins", "pit_test_horizon_dependence")),
        "L6_F_direction": _SubLayerSpecLocal(("direction_test", "direction_threshold", "direction_alpha")),
        "L6_G_residual": _SubLayerSpecLocal(("residual_test", "residual_lag_count", "residual_test_scope", "residual_alpha")),
    }
...
# Deferred core imports: placed after L6StatisticalTests so registry.py can
# import L6StatisticalTests without triggering a circular-dependency.
...
# Re-alias for internal use (mirrors original SubLayerSpec in core/layers/l6.py)
...
def validate_layer(layer: dict[str, Any] | str, context: dict[str, Any] | None = None) -> Any:
...
def validate_recipe(recipe: "L6Recipe | dict[str, Any] | str") -> Any:
    from macroforecast.core.validator import ValidationReport
