...
from macroforecast.core.pipeline import GatePredicate


class Data:
    """Data recipe authoring marker used by the internal layer registry."""
...
L1_LAYER_SPEC = LayerImplementationSpec(
    ...
    sub_layers=(
        ...
        SubLayerSpec(
            id="l1_g",
            name="Regime definition",
            axes=("regime_definition", "regime_estimation_temporal_rule"),
        ),
    ),
    axes={
        "l1_a": {
            "panel_composition": AxisSpec(
                "panel_composition",
                _options(("official_only", "custom_panel_only", "official_plus_custom")),
                "official_only",
                sweepable=False,
            ),
            ...
            "information_set_type": AxisSpec(
                "information_set_type",
                _options(("final_revised_data", "pseudo_oos_on_revised_data")),
                "final_revised_data",
                sweepable=False,
            ),
            ...
            "fred_sd_frequency_policy": AxisSpec(
                "fred_sd_frequency_policy",
                _options((
                    "report_only",
                    "allow_mixed_frequency",
        ...
        "l1_b": {
            "target_structure": AxisSpec(
                "target_structure",
                _options(("single_target", "multi_target")),
                "single_target",
                sweepable=False,
            ),
        },
        "l1_c": {
            ...
            "release_lag_rule": AxisSpec(
                "release_lag_rule",
                _options(("ignore_release_lag", "fixed_lag_all_series", "series_specific_lag")),
                "ignore_release_lag",
                sweepable=False,
            ),
            "contemporaneous_x_rule": AxisSpec(
                "contemporaneous_x_rule",
                _options(("allow_same_period_predictors", "forbid_same_period_predictors")),
                "allow_same_period_predictors",
                sweepable=False,
            ),
        },
        "l1_d": {
            "target_geography_policy": AxisSpec(
                "target_geography_policy",
                _options(("single_state", "all_states", "selected_states")),
                "all_states",
                sweepable=False,
            ),
            ...
            "state_selection": AxisSpec(
                "state_selection",
                _options(("all_states", "selected_states")),
                "all_states",
                sweepable=False,
            ),
            "fred_sd_variable_group": AxisSpec(
                "fred_sd_variable_group",
                _options((
                    "all_sd_variables",
                    "labor_market_core",
            ...
            "sd_variable_selection": AxisSpec(
                "sd_variable_selection",
                _options(("all_sd_variables", "selected_sd_variables")),
                "all_sd_variables",
                sweepable=False,
            ),
        },
        "l1_e": {
            "sample_start_rule": AxisSpec(
                "sample_start_rule",
                _options(("earliest_available", "fixed_date", "max_balanced")),
                "max_balanced",
                sweepable=False,
            ),
            "sample_end_rule": AxisSpec(
                "sample_end_rule",
                _options(("latest_available", "fixed_date")),
                "latest_available",
                sweepable=False,
            ),
        },
        "l1_f": {
            "horizon_set": AxisSpec(
                "horizon_set",
                _options(("standard_md", "standard_qd", "single", "custom_list", "range_up_to_h")),
                "derived",
                sweepable=False,
            ),
        },
...
__all__ = ["Data", "data", "L1_LAYER_SPEC"]
