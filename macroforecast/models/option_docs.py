...
_F_MARS = _f(
    ...
    (
        ...
        "Runtime wraps ``sklearn-contrib-py-earth`` as an optional dep; install via "
        ...
        "an install hint when ``sklearn-contrib-py-earth`` is not present (mirrors the "
    ...
    when_not_to_use="Without ``[mars]`` extra installed, or on Python >=3.11 -- raises a clear NotImplementedError.",
    references=(
        _REF_DESIGN_L4,
        Reference(
