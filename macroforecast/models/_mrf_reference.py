# ruff: noqa
# mypy: ignore-errors
"""Vendored MacroRandomForest reference backend.

Derived from RyanLucas3/MacroRandomForest 1.0.6, MIT License.
Copyright (c) 2022 Ryan Lucas.
Source: https://github.com/RyanLucas3/MacroRandomForest
Documentation: https://mrf-web.readthedocs.io/
License notice: macroforecast/models/_mrf_reference.LICENSE

Local changes are limited to package integration and compatibility fixes needed
for macroforecast pandas inputs/outputs and current numpy scalar assignment.
"""
...
def _macroforecast_scalar(value):
    """Return a scalar for numpy/pandas versions that keep 1x1 matrices."""
            ...
            if len(ind) > 0:
                ...
                if len(ind_all) == 1:
                    ...
                    for j in range(len(fitted_vals)):
                        fitted[ind_all[j]] = _macroforecast_scalar(fitted_vals[j])
