...
MODEL_SPECS: dict[str, ModelSpec] = {
    ...
    "ucsv": _spec(
        ...
        default_params={
            ...
            "burn": 1000,
            "gamma": 0.2,
            "initial_obs_log_vol_variance": 10.0,
            "initial_level_log_vol_variance": 10.0,
            "random_state": 1071,
        },
        parameters=(
            ...
            _p(
                "initial_obs_log_vol_variance",
                10.0,
                "float",
                "Initial-prior variance for the observation log-volatility state.",
                False,
            ),
            _p(
                ...
                10.0,
                "float",
                "Initial-prior variance for the trend-innovation log-volatility state.",
                False,
            ),
