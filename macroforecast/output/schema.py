...
class L8Output:
    ...
    sub_layers = {
        "L8_A_export_format": _SubLayerSpecLocal(("export_format", "compression")),
        "L8_B_saved_objects": _SubLayerSpecLocal(("saved_objects", "model_artifacts_format")),
        "L8_C_provenance": _SubLayerSpecLocal(("provenance_fields", "manifest_format")),
        "L8_D_artifact_granularity": _SubLayerSpecLocal(("artifact_granularity", "naming_convention")),
    }
...
def validate_recipe(recipe: "L8Recipe | dict[str, Any] | str") -> Any:
    from macroforecast.core.validator import ValidationReport
