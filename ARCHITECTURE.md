...
> Generated by scriber for run `2026-05-22-cycle53-tutorial-howto-content` on 2026-05-22.
...
structure (tutorial / how-to / reference / explanation). C53 (this run) writes
the actual user-facing content: three narrative tutorials, six how-to task recipes
(new), two refactors, five redirect stubs, and broken-link fixes across three
polish files.
...
graph TD
    ...
    subgraph Docs["docs/ — Diataxis 4-Tier (C53 content)"]
