...
> Last updated: C59 — Statistical credibility hardening (Round 2 Cycle 4 of 6): Boruta argmax fallback removed (100% → 3.3% FP rate on null DGP), `n_shadow_copies` default 1 → 6, HHS tolerances tightened, R cross-reference suite added (rpy2-gated), `[validation]` pyproject extra.
