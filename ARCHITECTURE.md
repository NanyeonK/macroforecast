...
> Last updated: C61 — v0.9.3b1 release cut: Round 2 cross-review remediation (C56-C60) consolidated into release version. Version bump to 0.9.3b1, LICENSE added (MIT), `py.typed` PEP 561 marker, pyproject.toml metadata (Trove classifiers, authors, keywords). CHANGELOG synthesized from 5 unreleased cycles.
...
| Module / File | Layer | Purpose | Key Exports | Changed in C61 |
| --- | --- | --- | --- | --- |
...
| `macroforecast/__init__.py` | API | Package init, version declaration | `__version__` = `"0.9.3b1"` | yes (C61: version bump) |
