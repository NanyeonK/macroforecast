...
> Last updated: 2026-05-25 — Phase 0 (restructure/phase-0). Wizard subsystem removed: `macroforecast/wizard/`, `macroforecast/scaffold/wizard.py`, `macroforecast/core/stages.py`, stale `DEFAULT_PREPROCESSING_AXES` keys. C67 (2026-05-23) — R3-P4a tutorial standalone-first rewrite. C66: DAG jargon cleanup across public surface (464 → 10 in macroforecast/, 131 → 7 non-archive in docs/).
