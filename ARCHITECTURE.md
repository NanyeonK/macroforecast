...
> Last updated: C58 — Release pipeline manual gate + encyclopedia drift detection (Round 2 Cycle 3 of 6; `release.yml` converted to `workflow_dispatch`, two drift CI gate tests added to `tests/scaffold/`).
